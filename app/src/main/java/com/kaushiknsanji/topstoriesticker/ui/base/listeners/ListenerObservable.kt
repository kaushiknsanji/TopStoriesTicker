...
package com.kaushiknsanji.topstoriesticker.ui.base.listeners

import java.util.*
import java.util.concurrent.ConcurrentHashMap

/**
 * Class for Listener entities in the application.
 *
 * @param L The type of Listeners.
 *
 * @author Kaushik N Sanji
 */
class ListenerObservable<L> : ListenerHost<L> {
    // Thread-safe set of Listeners
    private val listeners: MutableSet<L> =
        Collections.newSetFromMap(ConcurrentHashMap<L, Boolean>(1))
